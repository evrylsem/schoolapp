                ...
                <ul>
                    ...
                    <?php
                        for($index=1; $index<=$numPages; $index++) {
                            echo "<li><a href='student-listing.php?page=$index'>$index</a></li>";
                        }
                    ?>
